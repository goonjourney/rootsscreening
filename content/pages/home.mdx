...
blocks:
  - title: One Hundred Years Walter Spies in Bali
    ...
    _template: hero
  - sectionTitle: Peta Roadshow
    _template: roadshowMap
  - sectionTitle: The Film & Kuratorial
    _template: filmCuratorial
  - sectionTitle: Exhibitions & Media
    _template: exhibitionsMedia
---